...
public class Idman {
    ...
    public void burpeeYap(int sayi) {
        if(burpee_sayisi==0){
            ...
            System.out.println("tebrikler..hedefledigin burpee sayisini gectiniz..");
            burpee_sayisi=0;
    ...
    public void pushupYap(int sayi) {
        if(pushup_sayisi==0){
            ...
            System.out.println("tebrikler..hedeflediginiz pushup sayisini gectiniz..");
            pushup_sayisi=0;
    ...
    public void situpYap(int sayi) {
        if(situp_sayisi==0){
            System.out.println("yapacak situop sayisi kalmadi..");
        }
        else if(situp_sayisi-sayi<0) {
            System.out.println("tebrikler..hedefledigin situp sayisini gectiniz..");
            situp_sayisi=0;
    ...
    public void squatYap(int sayi) {
        if(squat_sayisi==0){
            ...
            System.out.println("tebrikler..hedefledigin squat sayisini gectiniz..");
            squat_sayisi=0;
